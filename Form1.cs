...
namespace EarlyLateGame
{
    public partial class Form1 : Form
    {
        BufferedGraphics buffer;
         public static string textOfbox;
        Hrac hrac1 = new Hrac(0, 0);
        Graphics g;
        Ctverecek[,] mapa = new Ctverecek[10, 10];
        //Ctverecek[,] vrstva2 = new Ctverecek[10, 10];  
        Graphics l;
        Hrac nepHrac = new Hrac(3, 4);
        ...
        public Form1()
        {
            ...
            for (int y = 0; y < 10; y++)
            {
                for (int x = 0; x < 10; x++)
                {
                    ...
                    mapa[y, x] = new Ctverecek(x, y, 60, 60, Color.White, false);
                }
            }
